...
export function WhatsAppCTA() {
    return (
        <motion.a
            ...
            className="fixed bottom-8 right-8 z-50 p-4 bg-[#25D366] text-white rounded-full shadow-[0_10px_30px_rgba(37,211,102,0.3)] hover:shadow-[0_10px_40px_rgba(37,211,102,0.5)] transition-all flex items-center justify-center border-2 border-white/20 group"
        >
